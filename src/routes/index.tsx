    ...
    <PageShell>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="mx-auto grid max-w-7xl items-center gap-10 px-6 py-12 md:grid-cols-2 md:gap-16 md:px-8 md:py-20">
          <motion.div initial={{ opacity: 0, x: -30 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.4, ease: "easeOut" }}>
      ...
      <section className="mx-auto max-w-7xl px-6 py-16 md:px-8">
        ...
        <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {[
            ...
            <motion.div key={c.name} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.3, delay: i * 0.05 }}>
        ...
        <div className="mx-auto max-w-7xl px-6 md:px-8">
          ...
          <div className="mt-12 grid gap-6 md:grid-cols-4">
            {[
              ...
              <motion.div key={s.n} initial={{ opacity:0, y:20 }} whileInView={{ opacity:1, y:0 }} viewport={{once:true}} transition={{duration:0.3, delay:i*0.05}}
